...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("PepperEngine", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("PepperEngine", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "PepperEngine";
		app.meta["name"] = "Friday Night Funkin': PepperEngine";
		app.meta["packageName"] = "com.example.myapp";
		app.meta["version"] = "0.0.0.0";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': PepperEngine",
			width: 1280,
			x: null,
			y: null,
		};
