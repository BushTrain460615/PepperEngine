...
HXLINE( 248)		 ::flixel::graphics::frames::FlxAtlasFrames tex = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(HX_("assets/images/alphabet.png",99,1b,4b,9b),HX_("assets/images/alphabet.xml",c7,2c,51,9b));
