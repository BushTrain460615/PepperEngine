...
HXDLIN( 207)					::String _hx_tmp1 = ((HX_("assets/sounds/",1f,fa,fb,94) + daSound) + ::flixel::FlxG_obj::random->_hx_int(1,4,null()));
HXDLIN( 207)					_hx_tmp->play((_hx_tmp1 + ::TitleState_obj::soundExt),((Float)0.4),null(),null(),null(),null());
            				}
