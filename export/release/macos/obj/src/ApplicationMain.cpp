...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("PepperEngine",64,98,53,14),::ApplicationMain_obj::create_dyn());
...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("24",c2,2b,00,00));
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("ninjamuffin99",f7,4c,e5,00));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("PepperEngine",64,98,53,14));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Friday Night Funkin': PepperEngine",37,44,b9,25));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.example.myapp",84,30,57,c1));
HXLINE(  40)		app->meta->set(HX_("version",18,e7,f1,7c),HX_("0.0.0.0",76,1a,39,f2));
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Friday Night Funkin': PepperEngine",37,44,b9,25))
