...
HXLINE(  12)		this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(HX_("assets/images/limo/limoDancer.png",fe,51,93,2a),HX_("assets/images/limo/limoDancer.xml",2c,63,99,2a)));
