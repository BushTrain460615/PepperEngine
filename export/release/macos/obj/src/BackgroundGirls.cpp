...
HXLINE(  13)		this->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(HX_("assets/images/weeb/bgFreaks.png",89,67,50,76),HX_("assets/images/weeb/bgFreaks.xml",b7,78,56,76)));
HXLINE(  15)		 ::flixel::animation::FlxAnimationController _hx_tmp = this->animation;
HXDLIN(  15)		_hx_tmp->addByIndices(HX_("danceLeft",da,cc,f9,df),HX_("BG girls group",1b,d2,55,9d),::CoolUtil_obj::numberArray(14,null()),HX_("",00,00,00,00),24,false,null(),null());
HXLINE(  16)		 ::flixel::animation::FlxAnimationController _hx_tmp1 = this->animation;
HXDLIN(  16)		_hx_tmp1->addByIndices(HX_("danceRight",a9,7f,a6,91),HX_("BG girls group",1b,d2,55,9d),::CoolUtil_obj::numberArray(30,15),HX_("",00,00,00,00),24,false,null(),null());
