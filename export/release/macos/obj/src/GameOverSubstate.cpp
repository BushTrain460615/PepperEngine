...
HXLINE(  43)		::flixel::FlxG_obj::sound->play(((HX_("assets/sounds/fnf_loss_sfx",09,63,cc,1f) + this->stageSuffix) + ::TitleState_obj::soundExt),null(),null(),null(),null(),null());
...
HXLINE(  80)			::flixel::FlxG_obj::sound->playMusic(((HX_("assets/music/gameOver",9c,63,c0,78) + this->stageSuffix) + ::TitleState_obj::soundExt),null(),null(),null());
            		}
...
HXLINE( 110)					 ::flixel::FlxState nextState =  ::PlayState_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE( 105)			::flixel::FlxG_obj::sound->play(((HX_("assets/music/gameOverEnd",9f,81,b1,56) + this->stageSuffix) + ::TitleState_obj::soundExt),null(),null(),null(),null(),null());
