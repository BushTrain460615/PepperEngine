...
HXLINE(  24)		 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->loadGraphic(HX_("assets/images/pauseAlt/pauseBG.png",a5,08,02,6b),null(),null(),null(),null(),null());
HXLINE(  25)		this->add(bg);
HXLINE(  27)		 ::flixel::FlxSprite bf =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,30,null());
HXLINE(  28)		bf->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(HX_("assets/images/pauseAlt/bfLol.png",cf,9a,08,95),HX_("assets/images/pauseAlt/bfLol.xml",fd,ab,0e,95)));
...
HXLINE(  35)		 ::flixel::FlxSprite _hx_tmp = this->replayButton;
HXDLIN(  35)		_hx_tmp->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(HX_("assets/images/pauseAlt/pauseUI.png",b4,0c,97,2a),HX_("assets/images/pauseAlt/pauseUI.xml",e2,1d,9d,2a)));
...
HXLINE(  42)		 ::flixel::FlxSprite _hx_tmp1 = this->cancelButton;
HXDLIN(  42)		_hx_tmp1->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(HX_("assets/images/pauseAlt/pauseUI.png",b4,0c,97,2a),HX_("assets/images/pauseAlt/pauseUI.xml",e2,1d,9d,2a)));
