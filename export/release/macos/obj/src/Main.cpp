...
HXLINE(  12)		this->addChild( ::flixel::FlxGame_obj::__alloc( HX_CTX ,0,0,::hx::ClassOf< ::TitleState >(),null(),null(),null(),null(),null()));
HXLINE(  15)		this->addChild( ::openfl::display::FPS_obj::__alloc( HX_CTX ,10,3,16777215));
            	}
