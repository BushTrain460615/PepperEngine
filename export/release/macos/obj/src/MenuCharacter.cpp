...
HXLINE(  16)		 ::flixel::graphics::frames::FlxAtlasFrames tex = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(HX_("assets/images/campaign_menu_UI_characters.png",14,63,48,77),HX_("assets/images/campaign_menu_UI_characters.xml",42,74,4e,77));
HXLINE(  17)		this->set_frames(tex);
