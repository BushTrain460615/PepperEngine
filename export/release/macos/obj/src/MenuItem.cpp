...
HXLINE(  17)		 ::flixel::graphics::frames::FlxAtlasFrames tex = ::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(HX_("assets/images/campaign_menu_UI_assets.png",ed,2f,e7,33),HX_("assets/images/campaign_menu_UI_assets.xml",1b,41,ed,33));
HXLINE(  19)		this->week =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null());
HXLINE(  20)		this->week->set_frames(tex);
HXLINE(  22)		this->week->animation->addByPrefix(HX_("week0",bc,95,be,c7),HX_("tutorial selected",1d,d7,30,55),24,null(),null(),null());
HXLINE(  23)		this->week->animation->addByPrefix(HX_("week1",bd,95,be,c7),HX_("WEEK1 select",ff,06,57,44),24,null(),null(),null());
HXLINE(  24)		this->week->animation->addByPrefix(HX_("week2",be,95,be,c7),HX_("week2 select",1e,b1,c0,38),24,null(),null(),null());
HXLINE(  25)		this->week->animation->addByPrefix(HX_("week3",bf,95,be,c7),HX_("Week 3 press",ca,8b,1f,3b),24,null(),null(),null());
HXLINE(  26)		this->week->animation->addByPrefix(HX_("week4",c0,95,be,c7),HX_("Week 4 press",8b,02,b5,64),24,null(),null(),null());
HXLINE(  27)		this->week->animation->addByPrefix(HX_("week5",c1,95,be,c7),HX_("week 5",09,61,04,ff),24,null(),null(),null());
HXLINE(  28)		this->week->animation->addByPrefix(HX_("week6",c2,95,be,c7),HX_("Week 6",2a,d5,98,33),24,null(),null(),null());
HXLINE(  29)		this->add(this->week);
HXLINE(  31)		this->week->animation->play((HX_("week",f4,5f,f5,4e) + weekNum),null(),null(),null());
HXLINE(  32)		{
HXLINE(  32)			 ::flixel::animation::FlxAnimationController _this = this->week->animation;
HXDLIN(  32)			if (::hx::IsNotNull( _this->_curAnim )) {
HXLINE(  32)				_this->_curAnim->pause();
            			}
            		}
HXLINE(  33)		this->week->updateHitbox();
            	}
