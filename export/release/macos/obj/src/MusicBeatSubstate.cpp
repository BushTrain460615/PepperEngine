...
HX_LOCAL_STACK_FRAME(_hx_pos_81b525467515cd1c_25_create,"MusicBeatSubstate","create",0x5b9a7ede,"MusicBeatSubstate.create","MusicBeatSubstate.hx",25,0x55a559f2)
HX_LOCAL_STACK_FRAME(_hx_pos_81b525467515cd1c_34_update,"MusicBeatSubstate","update",0x66909deb,"MusicBeatSubstate.update","MusicBeatSubstate.hx",34,0x55a559f2)
HX_LOCAL_STACK_FRAME(_hx_pos_81b525467515cd1c_49_updateCurStep,"MusicBeatSubstate","updateCurStep",0x817e4641,"MusicBeatSubstate.updateCurStep","MusicBeatSubstate.hx",49,0x55a559f2)
HX_LOCAL_STACK_FRAME(_hx_pos_81b525467515cd1c_66_stepHit,"MusicBeatSubstate","stepHit",0x3b6b7c45,"MusicBeatSubstate.stepHit","MusicBeatSubstate.hx",66,0x55a559f2)
...
void MusicBeatSubstate_obj::create(){
            	HX_STACKFRAME(&_hx_pos_81b525467515cd1c_25_create)
HXLINE(  27)		::TitleState_obj::soundExt = HX_(".ogg",e1,64,bc,1e);
HXLINE(  30)		this->super::create();
            	}


void MusicBeatSubstate_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_81b525467515cd1c_34_update)
HXLINE(  36)		int oldStep = this->curStep;
HXLINE(  38)		this->updateCurStep();
HXLINE(  39)		this->curBeat = ::Math_obj::floor((( (Float)(this->curStep) ) / ( (Float)(4) )));
HXLINE(  41)		bool _hx_tmp;
HXDLIN(  41)		if ((oldStep != this->curStep)) {
HXLINE(  41)			_hx_tmp = (this->curStep > 0);
            		}
            		else {
HXLINE(  41)			_hx_tmp = false;
            		}
HXDLIN(  41)		if (_hx_tmp) {
HXLINE(  42)			this->stepHit();
            		}
...
void MusicBeatSubstate_obj::updateCurStep(){
            	HX_STACKFRAME(&_hx_pos_81b525467515cd1c_49_updateCurStep)
HXLINE(  50)		 ::Dynamic lastChange =  ::Dynamic(::hx::Anon_obj::Create(3)
            			->setFixed(0,HX_("stepTime",79,75,25,a0),0)
            			->setFixed(1,HX_("bpm",df,be,4a,00),0)
            			->setFixed(2,HX_("songTime",82,2a,d5,3a),( (Float)(0) )));
HXLINE(  55)		{
HXLINE(  55)			int _g = 0;
HXDLIN(  55)			int _g1 = ::Conductor_obj::bpmChangeMap->length;
HXDLIN(  55)			while((_g < _g1)){
HXLINE(  55)				_g = (_g + 1);
HXDLIN(  55)				int i = (_g - 1);
HXLINE(  57)				if (::hx::IsGreater( ::Conductor_obj::songPosition,::Conductor_obj::bpmChangeMap->__get(i)->__Field(HX_("songTime",82,2a,d5,3a),::hx::paccDynamic) )) {
HXLINE(  58)					lastChange = ::Conductor_obj::bpmChangeMap->__get(i);
            				}
            			}
            		}
HXLINE(  61)		this->curStep = ( (int)((lastChange->__Field(HX_("stepTime",79,75,25,a0),::hx::paccDynamic) + ::Math_obj::floor(((::Conductor_obj::songPosition - ( (Float)(lastChange->__Field(HX_("songTime",82,2a,d5,3a),::hx::paccDynamic)) )) / ::Conductor_obj::stepCrochet)))) );
            	}
...
void MusicBeatSubstate_obj::stepHit(){
            	HX_STACKFRAME(&_hx_pos_81b525467515cd1c_66_stepHit)
HXDLIN(  66)		if ((::hx::Mod(this->curStep,4) == 0)) {
