...
HXLINE(  20)		 ::flixel::text::FlxText txt =  ::flixel::text::FlxText_obj::__alloc( HX_CTX ,0,0,::flixel::FlxG_obj::width,((((HX_("HEY! You're running an outdated version of PepperEngine!\nCurrent version is ",29,b8,8f,8f) + ver) + HX_(" while the most recent version is ",a8,e4,a2,d4)) + ::NGio_obj::GAME_VER) + HX_("! Press Space to go to Github, or ESCAPE to ignore this!!",7c,7f,42,c2)),32,null());
...
HXDLIN(  36)			if (!( ::EReg_obj::__alloc( HX_CTX ,HX_("^https?://",48,ee,dd,38),HX_("",00,00,00,00))->match(HX_("https://github.com/JuniorNovoa1/PepperEngine",d6,a6,e2,d3)))) {
HXLINE(  36)				prefix = HX_("http://",52,75,cd,5a);
            			}
HXDLIN(  36)			::openfl::Lib_obj::getURL( ::openfl::net::URLRequest_obj::__alloc( HX_CTX ,(prefix + HX_("https://github.com/JuniorNovoa1/PepperEngine",d6,a6,e2,d3))),HX_("_blank",95,26,d9,b0));
            		}
