...
HXLINE(  43)		::String rawJson = ((HX_("assets/data/",f9,10,73,a0) + folder.toLowerCase()) + HX_("/",2f,00,00,00));
HXDLIN(  43)		::String rawJson1 = ::StringTools_obj::trim(::lime::utils::Assets_obj::getText(((rawJson + jsonInput.toLowerCase()) + HX_(".json",56,f1,d6,c2))));
HXLINE(  45)		while(!(::StringTools_obj::endsWith(rawJson1,HX_("}",7d,00,00,00)))){
HXLINE(  47)			rawJson1 = rawJson1.substr(0,(rawJson1.length - 1));
            		}
HXLINE(  67)		return ::Song_obj::parseJSONshit(rawJson1);
            	}
