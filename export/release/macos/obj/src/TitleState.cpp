...
HX_DEFINE_STACK_FRAME(_hx_pos_a55214e0452daa02_30_new,"TitleState","new",0x3b23deeb,"TitleState.new","TitleState.hx",30,0xd132a6e5)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_104_startIntro,"TitleState","startIntro",0x6a094b7f,"TitleState.startIntro","TitleState.hx",104,0xd132a6e5)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_211_getIntroTextShit,"TitleState","getIntroTextShit",0x5dcf15b8,"TitleState.getIntroTextShit","TitleState.hx",211,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_228_update,"TitleState","update",0x8b12e05e,"TitleState.update","TitleState.hx",228,0xd132a6e5)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_398_skipIntro,"TitleState","skipIntro",0xc9924038,"TitleState.skipIntro","TitleState.hx",398,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_32_boot,"TitleState","boot",0x7c582f47,"TitleState.boot","TitleState.hx",32,0xd132a6e5)
HX_LOCAL_STACK_FRAME(_hx_pos_a55214e0452daa02_33_boot,"TitleState","boot",0x7c582f47,"TitleState.boot","TitleState.hx",33,0xd132a6e5)
...
void TitleState_obj::__construct( ::flixel::addons::transition::TransitionData TransIn, ::flixel::addons::transition::TransitionData TransOut){
            	HX_STACKFRAME(&_hx_pos_a55214e0452daa02_30_new)
HXLINE( 394)		this->skippedIntro = false;
HXLINE( 225)		this->transitioning = false;
HXLINE( 100)		this->danceLeft = false;
...
HXLINE(  45)		 ::TitleState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE(  47)		::polymod::Polymod_obj::init( ::Dynamic(::hx::Anon_obj::Create(2)
...
HXLINE(  50)		::TitleState_obj::soundExt = HX_(".ogg",e1,64,bc,1e);
...
void TitleState_obj::startIntro(){
            	HX_GC_STACKFRAME(&_hx_pos_a55214e0452daa02_104_startIntro)
HXLINE( 105)		if (!(::TitleState_obj::initialized)) {
HXLINE( 107)			 ::flixel::graphics::FlxGraphic diamond = ::flixel::graphics::FlxGraphic_obj::fromClass(::hx::ClassOf< ::flixel::addons::transition::GraphicTransTileDiamond >(),null(),null(),null());
HXLINE( 108)			diamond->persist = true;
HXLINE( 109)			diamond->set_destroyOnNoUse(false);
HXLINE( 111)			 ::flixel::math::FlxPoint _hx_tmp =  ::flixel::math::FlxPoint_obj::__alloc( HX_CTX ,0,-1);
HXDLIN( 111)			::flixel::addons::transition::FlxTransitionableState_obj::defaultTransIn =  ::flixel::addons::transition::TransitionData_obj::__alloc( HX_CTX ,HX_("fade",7c,b5,b5,43),-16777216,1,_hx_tmp, ::Dynamic(::hx::Anon_obj::Create(3)
...
HXLINE( 113)			 ::flixel::math::FlxPoint _hx_tmp1 =  ::flixel::math::FlxPoint_obj::__alloc( HX_CTX ,0,1);
HXDLIN( 113)			::flixel::addons::transition::FlxTransitionableState_obj::defaultTransOut =  ::flixel::addons::transition::TransitionData_obj::__alloc( HX_CTX ,HX_("fade",7c,b5,b5,43),-16777216,((Float)0.7),_hx_tmp1, ::Dynamic(::hx::Anon_obj::Create(3)
            				->setFixed(0,HX_("width",06,b6,62,ca),32)
            				->setFixed(1,HX_("height",e7,07,4c,02),32)
            				->setFixed(2,HX_("asset",f0,69,39,26),diamond)), ::flixel::math::FlxRect_obj::__alloc( HX_CTX ,-200,-200,(( (Float)(::flixel::FlxG_obj::width) ) * ((Float)1.4)),(( (Float)(::flixel::FlxG_obj::height) ) * ((Float)1.4))));
HXLINE( 116)			this->transIn = ::flixel::addons::transition::FlxTransitionableState_obj::defaultTransIn;
HXLINE( 117)			this->transOut = ::flixel::addons::transition::FlxTransitionableState_obj::defaultTransOut;
HXLINE( 127)			::flixel::FlxG_obj::sound->playMusic((HX_("assets/music/freakyMenu",cb,d3,74,22) + ::TitleState_obj::soundExt),0,null(),null());
HXLINE( 129)			{
...
HXDLIN( 129)				_this->fadeTween = ::flixel::tweens::FlxTween_obj::num(( (Float)(0) ),((Float)0.7),4, ::Dynamic(::hx::Anon_obj::Create(1)
            					->setFixed(0,HX_("onComplete",f8,d4,7e,5d),onComplete)),_this->volumeTween_dyn());
            			}
            		}
HXLINE( 132)		::Conductor_obj::changeBPM(102);
HXLINE( 133)		this->persistentUpdate = true;
HXLINE( 135)		 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->makeGraphic(::flixel::FlxG_obj::width,::flixel::FlxG_obj::height,-16777216,null(),null());
HXLINE( 139)		this->add(bg);
HXLINE( 141)		this->logoBl =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-150,-100,null());
HXLINE( 142)		 ::flixel::FlxSprite _hx_tmp = this->logoBl;
HXDLIN( 142)		_hx_tmp->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(HX_("assets/images/logoBumpin.png",4c,c0,28,86),HX_("assets/images/logoBumpin.xml",7a,d1,2e,86)));
HXLINE( 143)		this->logoBl->set_antialiasing(true);
HXLINE( 144)		this->logoBl->animation->addByPrefix(HX_("bump",f6,0f,20,41),HX_("logo bumpin",70,a1,0b,72),24,null(),null(),null());
HXLINE( 145)		this->logoBl->animation->play(HX_("bump",f6,0f,20,41),null(),null(),null());
...
HXLINE( 151)		 ::flixel::FlxSprite _hx_tmp1 = this->gfDance;
HXDLIN( 151)		_hx_tmp1->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(HX_("assets/images/gfDanceTitle.png",4a,21,8a,cf),HX_("assets/images/gfDanceTitle.xml",78,32,90,cf)));
HXLINE( 152)		this->gfDance->animation->addByIndices(HX_("danceLeft",da,cc,f9,df),HX_("gfDance",94,88,3a,eb),::Array_obj< int >::fromData( _hx_array_data_8ca18d79_5,16),HX_("",00,00,00,00),24,false,null(),null());
HXLINE( 153)		this->gfDance->animation->addByIndices(HX_("danceRight",a9,7f,a6,91),HX_("gfDance",94,88,3a,eb),::Array_obj< int >::fromData( _hx_array_data_8ca18d79_6,15),HX_("",00,00,00,00),24,false,null(),null());
HXLINE( 154)		this->gfDance->set_antialiasing(true);
...
HXLINE( 159)		 ::flixel::FlxSprite _hx_tmp2 = this->titleText;
HXDLIN( 159)		_hx_tmp2->set_frames(::flixel::graphics::frames::FlxAtlasFrames_obj::fromSparrow(HX_("assets/images/titleEnter.png",86,9a,cd,1d),HX_("assets/images/titleEnter.xml",b4,ab,d3,1d)));
...
HXLINE( 162)		this->titleText->set_antialiasing(true);
...
HXLINE( 168)		 ::flixel::FlxSprite logo =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,null(),null(),null())->loadGraphic(HX_("assets/images/logo.png",d1,c8,3b,1e),null(),null(),null(),null(),null());
HXLINE( 169)		logo->screenCenter(null());
HXLINE( 170)		logo->set_antialiasing(true);
...
HXLINE( 190)		this->ngSpr =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,0,(( (Float)(::flixel::FlxG_obj::height) ) * ((Float)0.52)),null())->loadGraphic(HX_("assets/images/newgrounds_logo.png",8e,ff,24,4d),null(),null(),null(),null(),null());
...
HXLINE( 196)		this->ngSpr->set_antialiasing(true);
...
HXLINE( 205)			::TitleState_obj::initialized = true;
            		}
            	}
...
::Array< ::Dynamic> TitleState_obj::getIntroTextShit(){
            	HX_STACKFRAME(&_hx_pos_a55214e0452daa02_211_getIntroTextShit)
HXLINE( 212)		::String fullText = ::openfl::utils::Assets_obj::getText(HX_("assets/data/introText.txt",22,40,e0,6c));
HXLINE( 214)		::Array< ::String > firstArray = fullText.split(HX_("\n",0a,00,00,00));
HXLINE( 215)		::Array< ::Dynamic> swagGoodArray = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 217)		{
HXLINE( 217)			int _g = 0;
HXDLIN( 217)			while((_g < firstArray->length)){
HXLINE( 217)				::String i = firstArray->__get(_g);
HXDLIN( 217)				_g = (_g + 1);
HXLINE( 219)				swagGoodArray->push(i.split(HX_("--",60,27,00,00)));
            			}
            		}
HXLINE( 222)		return swagGoodArray;
            	}
...
void TitleState_obj::update(Float elapsed){
            	HX_GC_STACKFRAME(&_hx_pos_a55214e0452daa02_228_update)
HXLINE( 229)		if (::hx::IsNotNull( ::flixel::FlxG_obj::sound->music )) {
HXLINE( 230)			::Conductor_obj::songPosition = ::flixel::FlxG_obj::sound->music->_time;
            		}
HXLINE( 233)		 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 233)		if (_this->keyManager->checkStatus(70,_this->status)) {
HXLINE( 235)			::flixel::FlxG_obj::set_fullscreen(!(::flixel::FlxG_obj::get_fullscreen()));
            		}
HXLINE( 238)		 ::flixel::input::keyboard::FlxKeyList _this1 = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 238)		bool pressedEnter = _this1->keyManager->checkStatus(13,_this1->status);
HXLINE( 240)		 ::flixel::input::gamepad::FlxGamepad gamepad = ::flixel::FlxG_obj::gamepads->lastActive;
HXLINE( 242)		if (::hx::IsNotNull( gamepad )) {
HXLINE( 244)			 ::flixel::input::gamepad::lists::FlxGamepadButtonList _this = gamepad->justPressed;
HXDLIN( 244)			int id = 7;
HXDLIN( 244)			 ::flixel::input::gamepad::FlxGamepad _this1 = _this->gamepad;
HXDLIN( 244)			int Status = _this->status;
HXDLIN( 244)			bool _hx_tmp;
HXDLIN( 244)			switch((int)(id)){
            				case (int)-2: {
HXLINE( 244)					_hx_tmp = _this1->anyButton(Status);
            				}
            				break;
            				case (int)-1: {
HXLINE( 244)					_hx_tmp = !(_this1->anyButton(Status));
            				...
            				break;
            				default:{
HXLINE( 244)					int RawID = _this1->mapping->getRawID(id);
HXDLIN( 244)					 ::flixel::input::gamepad::FlxGamepadButton button = _this1->buttons->__get(RawID).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 244)					if (::hx::IsNotNull( button )) {
HXLINE( 244)						_hx_tmp = button->hasState(Status);
            					}
            					else {
...
HXLINE( 245)				pressedEnter = true;
            			}
            		}
HXLINE( 253)		bool _hx_tmp;
HXDLIN( 253)		bool _hx_tmp1;
HXDLIN( 253)		if (pressedEnter) {
HXLINE( 253)			_hx_tmp1 = !(this->transitioning);
            		}
            		else {
HXLINE( 253)			_hx_tmp1 = false;
            		}
HXDLIN( 253)		if (_hx_tmp1) {
HXLINE( 253)			_hx_tmp = this->skippedIntro;
            		}
            		else {
...
HXLINE( 275)				::String version = (HX_("v",76,00,00,00) + ::lime::app::Application_obj::current->meta->get(HX_("version",18,e7,f1,7c)));
HXLINE( 277)				bool _hx_tmp;
HXDLIN( 277)				::String _hx_tmp1 = ::StringTools_obj::trim(version);
HXDLIN( 277)				if ((_hx_tmp1 != ::NGio_obj::GAME_VER_NUMS)) {
HXLINE( 277)					_hx_tmp = !(::OutdatedSubState_obj::leftState);
            				}
            				else {
HXLINE( 277)					_hx_tmp = false;
            				}
HXDLIN( 277)				if (_hx_tmp) {
HXLINE( 279)					::haxe::Log_obj::trace(HX_("OLD VERSION!",e2,80,4d,2e),::hx::SourceInfo(HX_("source/TitleState.hx",71,4f,0c,46),279,HX_("TitleState",79,8d,a1,8c),HX_("update",09,86,05,87)));
HXLINE( 280)					{
...
HXLINE( 256)			if (::NGio_obj::isLoggedIn) {
HXLINE( 256)				 ::io::newgrounds::objects::Medal medal = ( ( ::io::newgrounds::objects::Medal)(::io::newgrounds::NG_obj::core->medals->get(60960)) );
HXDLIN( 256)				if (!(( (bool)(medal->_data->__Field(HX_("unlocked",23,34,0e,5c),::hx::paccDynamic)) ))) {
HXLINE( 256)					medal->sendUnlock();
            				}
            			}
HXLINE( 259)			if ((::Date_obj::now()->getDay() == 5)) {
HXLINE( 260)				if (::NGio_obj::isLoggedIn) {
HXLINE( 260)					 ::io::newgrounds::objects::Medal medal = ( ( ::io::newgrounds::objects::Medal)(::io::newgrounds::NG_obj::core->medals->get(61034)) );
HXDLIN( 260)					if (!(( (bool)(medal->_data->__Field(HX_("unlocked",23,34,0e,5c),::hx::paccDynamic)) ))) {
HXLINE( 260)						medal->sendUnlock();
            					}
            				}
            			}
HXLINE( 263)			this->titleText->animation->play(HX_("press",83,53,88,c8),null(),null(),null());
HXLINE( 265)			::flixel::FlxG_obj::camera->flash(-1,1,null(),null());
HXLINE( 266)			::flixel::FlxG_obj::sound->play((HX_("assets/sounds/confirmMenu",00,1b,1f,8b) + ::TitleState_obj::soundExt),((Float)0.7),null(),null(),null(),null());
HXLINE( 268)			this->transitioning = true;
HXLINE( 271)			 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(2, ::Dynamic(new _hx_Closure_0()),null());
            		}
HXLINE( 290)		bool _hx_tmp2;
HXDLIN( 290)		if (pressedEnter) {
HXLINE( 290)			_hx_tmp2 = !(this->skippedIntro);
            		}
            		else {
...
HXLINE( 304)			{
HXLINE( 304)				 ::Alphabet _g1 = money;
HXDLIN( 304)				_g1->set_y((_g1->y + ((i * 60) + 200)));
            			}
...
HXLINE( 314)		{
HXLINE( 314)			 ::Alphabet _g = coolText;
HXDLIN( 314)			_g->set_y((_g->y + ((this->textGroup->length * 60) + 200)));
            		}
...
HXLINE( 332)		this->logoBl->animation->play(HX_("bump",f6,0f,20,41),null(),null(),null());
...
HXLINE( 342)		switch((int)(this->curBeat)){
            			case (int)1: {
HXLINE( 345)				this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_17,4));
            			}
            			break;
            			case (int)3: {
HXLINE( 348)				this->addMoreText(HX_("present",fb,3a,dc,39));
            			}
            			break;
            			case (int)4: {
HXLINE( 352)				this->deleteCoolText();
            			...
            			break;
            			case (int)5: {
HXLINE( 357)				this->createCoolText(::Array_obj< ::String >::fromData( _hx_array_data_8ca18d79_18,2));
            			}
            			break;
            			case (int)7: {
HXLINE( 359)				this->addMoreText(HX_("newgrounds",ac,0f,a7,f6));
HXLINE( 360)				this->ngSpr->set_visible(true);
            			}
            			break;
            			case (int)8: {
HXLINE( 363)				this->deleteCoolText();
HXLINE( 364)				this->ngSpr->set_visible(false);
            			}
            			break;
            			case (int)9: {
HXLINE( 370)				this->createCoolText(::Array_obj< ::String >::__new(1)->init(0,this->curWacky->__get(0)));
            			}
            			break;
            			case (int)11: {
HXLINE( 373)				this->addMoreText(this->curWacky->__get(1));
            			}
            			break;
            			case (int)12: {
HXLINE( 376)				this->deleteCoolText();
            			}
            			break;
            			case (int)13: {
HXLINE( 381)				this->addMoreText(HX_("Friday",ff,00,5d,e6));
            			}
            			break;
            			case (int)14: {
HXLINE( 384)				this->addMoreText(HX_("Night",b8,29,f7,2e));
            			}
            			break;
            			case (int)15: {
HXLINE( 387)				this->addMoreText(HX_("Funkin PepperEngine",93,c3,36,dd));
            			}
            			break;
            			case (int)16: {
HXLINE( 390)				this->skipIntro();
            			}
            			break;
            		}
            	}
...
void TitleState_obj::skipIntro(){
            	HX_STACKFRAME(&_hx_pos_a55214e0452daa02_398_skipIntro)
HXDLIN( 398)		if (!(this->skippedIntro)) {
HXLINE( 400)			this->remove(this->ngSpr,null());
HXLINE( 402)			::flixel::FlxG_obj::camera->flash(-1,4,null(),null());
HXLINE( 403)			this->remove(this->credGroup,null());
HXLINE( 404)			this->skippedIntro = true;
            		}
            	}
...
::String TitleState_obj::soundExt;
...
static ::hx::StaticInfo TitleState_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsString,(void *) &TitleState_obj::soundExt,HX_("soundExt",12,e3,9a,19)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
{
{
            	HX_STACKFRAME(&_hx_pos_a55214e0452daa02_32_boot)
HXDLIN(  32)		initialized = false;
            	}
{
            	HX_STACKFRAME(&_hx_pos_a55214e0452daa02_33_boot)
HXDLIN(  33)		soundExt = HX_(".mp3",02,e8,ba,1e);
            	}
}
