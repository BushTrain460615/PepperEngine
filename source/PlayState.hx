...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		else
		{
			...
			var stage_light:FlxSprite = new FlxSprite(-50, -100).loadGraphic('assets/images/stage_light.png');
			stage_light.setGraphicSize(Std.int(stage_light.width * 0.9));
			stage_light.updateHitbox();
			stage_light.antialiasing = true;
			stage_light.scrollFactor.set(1.3, 1.3);
			stage_light.active = false;
            add(stage_light);

			var stage_light2:FlxSprite = new FlxSprite(1100, -100).loadGraphic('assets/images/stage_light2.png');
			stage_light2.setGraphicSize(Std.int(stage_light2.width * 0.9));
			stage_light2.updateHitbox();
			stage_light2.antialiasing = true;
			stage_light2.scrollFactor.set(1.3, 1.3);
			stage_light2.active = false;
            add(stage_light2);
